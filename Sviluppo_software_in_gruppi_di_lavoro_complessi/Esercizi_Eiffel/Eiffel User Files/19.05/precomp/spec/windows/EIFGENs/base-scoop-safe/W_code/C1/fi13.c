...
#define uw1 uw1x.it_c4
	...
	RTCC(arg1, 12, l_feature_name, 1, eif_new_type(237, 0x01), 0x01);
	RTIV(Current, RTAL);
...
#define ub1 ub1x.it_b
	...
	RTCC(arg1, 12, l_feature_name, 1, eif_new_type(185, 0x01), 0x01);
	RTCC(arg2, 12, l_feature_name, 2, eif_new_type(229, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
#define ur2 ur2x.it_r
	...
	RTCC(arg1, 12, l_feature_name, 1, eif_new_type(229, 0x01), 0x01);
	RTCC(arg2, 12, l_feature_name, 2, eif_new_type(229, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ur1 ur1x.it_r
	...
	RTCC(arg1, 12, l_feature_name, 1, eif_new_type(185, 0x01), 0x01);
	RTCC(arg2, 12, l_feature_name, 2, eif_new_type(185, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if (loc3) {
