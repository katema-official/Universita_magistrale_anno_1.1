...
extern EIF_TYPED_VALUE F8_56(EIF_REFERENCE);
extern void F8_57(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F8_56 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 7, Current, 0, 0, 68);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(7, Current, 68);
	RTIV(Current, RTAL);
...
void F8_57 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 7, Current, 0, 1, 69);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(7, Current, 69);
	RTIV(Current, RTAL);
