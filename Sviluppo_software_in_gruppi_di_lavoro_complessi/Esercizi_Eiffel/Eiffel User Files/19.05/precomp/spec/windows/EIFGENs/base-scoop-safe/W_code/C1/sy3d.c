...
static const EIF_TYPE_INDEX egt_0_3 [] = {0xFF01,232,0xFFFF};
static const EIF_TYPE_INDEX egt_1_3 [] = {0xFF01,245,2,0xFFFF};
...
static const EIF_TYPE_INDEX egt_8_3 [] = {0xFF01,14,0xFFFF};
static const EIF_TYPE_INDEX egt_9_3 [] = {0xFF01,232,0xFFFF};
static const EIF_TYPE_INDEX egt_10_3 [] = {0xFF01,232,0xFFFF};
static const EIF_TYPE_INDEX egt_11_3 [] = {0xFF01,15,0xFFFF};
static const EIF_TYPE_INDEX egt_12_3 [] = {0xFF01,2,0xFFFF};
static const EIF_TYPE_INDEX egt_13_3 [] = {0xFF01,27,0xFFFF};
...
static const struct desc_info desc_3[] = {
	...
	{EIF_NON_GENERIC(0x01B5 /*218*/), 36, 0xFFFFFFFF},
};
void Init3(void)
{
	IDSC(desc_3, 0, 2);
	IDSC(desc_3 + 1, 1, 2);
	IDSC(desc_3 + 32, 341, 2);
}
