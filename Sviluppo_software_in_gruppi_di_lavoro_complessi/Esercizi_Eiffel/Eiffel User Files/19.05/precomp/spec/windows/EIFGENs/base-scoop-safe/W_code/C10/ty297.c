...
extern EIF_TYPED_VALUE F297_4324(EIF_REFERENCE);
...
EIF_TYPED_VALUE F297_4324 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 296, Current, 0, 0, 8388);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(296, Current, 8388);
	RTIV(Current, RTAL);
