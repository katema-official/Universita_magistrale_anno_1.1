...
extern EIF_TYPED_VALUE F353_2551(EIF_REFERENCE);
extern void F353_7148(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F353_2551 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 352, Current, 0, 0, 3406);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(352, Current, 3406);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F353_7148 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 352, Current, 0, 7147);
	RTSA(dtype);
	RTME(dtype, 0);
