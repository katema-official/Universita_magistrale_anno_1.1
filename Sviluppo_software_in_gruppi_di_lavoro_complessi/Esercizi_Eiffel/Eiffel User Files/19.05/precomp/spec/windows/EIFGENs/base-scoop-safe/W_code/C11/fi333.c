...
extern EIF_TYPED_VALUE F333_2537(EIF_REFERENCE);
extern void F333_7146(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F333_2537 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 332, Current, 0, 0, 3361);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(332, Current, 3361);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F333_7146 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 332, Current, 0, 7145);
	RTSA(dtype);
	RTME(dtype, 0);
