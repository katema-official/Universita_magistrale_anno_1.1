...
extern EIF_TYPED_VALUE F360_3077(EIF_REFERENCE);
extern EIF_TYPED_VALUE F360_3080(EIF_REFERENCE);
extern void F360_7162(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F360_3077 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 359, Current, 0, 0, 3972);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(359, Current, 3972);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F360_3080 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 359, Current, 0, 0, 3973);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(359, Current, 3973);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F360_7162 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 359, Current, 0, 7161);
	RTSA(dtype);
	RTME(dtype, 0);
