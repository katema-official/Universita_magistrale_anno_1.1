...
extern void F391_4402(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F391_4407(EIF_REFERENCE);
...
void F391_4402 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 390, Current, 0, 1, 9149);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(390, Current, 9149);
	RTCC(arg1, 390, l_feature_name, 1, RTWCT(3238, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3238, 0xF8000163, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(3238, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 3225, 0xF8000177, 0); /* area */
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 390, Current, 0, 0, 9151);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(390, Current, 9151);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 390, Current, 0, 0, 9152);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(390, Current, 9152);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr2 == tr1)) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3208, 374))(Current)).it_b);
		tb1 = tb2;
	}
...
EIF_TYPED_VALUE F391_4407 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
