...
extern EIF_TYPED_VALUE F389_2551(EIF_REFERENCE);
extern void F389_7148(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F389_2551 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 388, Current, 0, 0, 3408);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(388, Current, 3408);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F389_7148 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 388, Current, 0, 7147);
	RTSA(dtype);
	RTME(dtype, 0);
