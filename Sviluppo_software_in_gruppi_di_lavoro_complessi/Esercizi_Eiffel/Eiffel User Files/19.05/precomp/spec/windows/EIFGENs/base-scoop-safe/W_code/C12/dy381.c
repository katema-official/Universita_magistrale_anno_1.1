...
extern void F381_3470(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F381_3472(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F381_3473(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F381_3477(EIF_REFERENCE);
...
void F381_3470 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 380, Current, 1, 1, 6225);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(380, Current, 6225);
	RTIV(Current, RTAL);
...
void F381_3472 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 380, Current, 0, 1, 6222);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(380, Current, 6222);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2258, "item", arg1))(arg1)).it_p);
		up1 = tp1;
...
void F381_3473 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 380, Current, 0, 1, 6223);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(380, Current, 6223);
	RTCC(arg1, 380, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F381_3477 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 380, Current, 0, 0, 6224);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(380, Current, 6224);
	RTIV(Current, RTAL);
	RTHOOK(1);
