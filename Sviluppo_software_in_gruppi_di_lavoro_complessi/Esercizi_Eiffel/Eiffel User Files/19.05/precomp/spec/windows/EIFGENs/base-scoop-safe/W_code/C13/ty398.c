...
extern EIF_TYPED_VALUE F398_4324(EIF_REFERENCE);
...
EIF_TYPED_VALUE F398_4324 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 397, Current, 0, 0, 8391);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(397, Current, 8391);
	RTIV(Current, RTAL);
