...
extern EIF_TYPED_VALUE F426_4324(EIF_REFERENCE);
...
EIF_TYPED_VALUE F426_4324 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 425, Current, 0, 0, 8392);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(425, Current, 8392);
	RTIV(Current, RTAL);
