...
extern void F453_4402(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F453_4403(EIF_REFERENCE);
extern EIF_TYPED_VALUE F453_4404(EIF_REFERENCE);
extern EIF_TYPED_VALUE F453_4405(EIF_REFERENCE);
extern EIF_TYPED_VALUE F453_4406(EIF_REFERENCE);
extern EIF_TYPED_VALUE F453_4407(EIF_REFERENCE);
...
void F453_4402 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 452, Current, 0, 1, 9155);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(452, Current, 9155);
	RTCC(arg1, 452, l_feature_name, 1, RTWCT(3238, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3238, 0xF80001A1, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(3238, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 3225, 0xF80001B5, 0); /* area */
	...
	*(EIF_REFERENCE *)(Current + RTWA(3225, dtype)) = (EIF_REFERENCE) tr2;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 3239, 0x10000000, 1); /* first_index */
	ti4_1 = *(EIF_INTEGER_32 *)(arg1 + RTVA(2664, "lower", arg1));
	*(EIF_INTEGER_32 *)(Current + RTWA(3239, dtype)) = (EIF_INTEGER_32) ti4_1;
	RTHOOK(5);
	RTDBGAA(Current, dtype, 3228, 0x10000000, 1); /* area_last_index */
	ti4_1 = *(EIF_INTEGER_32 *)(arg1 + RTVA(2663, "upper", arg1));
	ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(3239, dtype));
	*(EIF_INTEGER_32 *)(Current + RTWA(3228, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) (ti4_1 - ti4_2);
	if (RTAL & CK_ENSURE) {
		...
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(3239, dtype));
...
EIF_TYPED_VALUE F453_4403 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(3239,Dtype(Current)));
	return r;
}


/* {ARRAY_ITERATION_CURSOR}.new_cursor */
EIF_TYPED_VALUE F453_4404 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 452, Current, 0, 0, 9157);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(452, Current, 9157);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3238, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F453_4405 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 452, Current, 0, 0, 9158);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(452, Current, 9158);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr2 == tr1)) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3208, 436))(Current)).it_b);
		tb1 = tb2;
	}
...
EIF_TYPED_VALUE F453_4406 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F453_4407 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
