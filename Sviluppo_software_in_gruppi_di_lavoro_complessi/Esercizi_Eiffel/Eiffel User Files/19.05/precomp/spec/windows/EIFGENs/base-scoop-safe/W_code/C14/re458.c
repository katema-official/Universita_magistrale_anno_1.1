...
extern EIF_TYPED_VALUE F458_3077(EIF_REFERENCE);
extern EIF_TYPED_VALUE F458_3080(EIF_REFERENCE);
extern void F458_7162(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F458_3077 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 457, Current, 0, 0, 3981);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(457, Current, 3981);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F458_3080 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 457, Current, 0, 0, 3982);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(457, Current, 3982);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F458_7162 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 457, Current, 0, 7161);
	RTSA(dtype);
	RTME(dtype, 0);
