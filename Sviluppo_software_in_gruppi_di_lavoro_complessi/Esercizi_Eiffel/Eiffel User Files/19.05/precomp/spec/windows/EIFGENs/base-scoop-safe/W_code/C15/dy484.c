...
extern EIF_TYPED_VALUE F484_3316(EIF_REFERENCE);
extern EIF_TYPED_VALUE F484_3317(EIF_REFERENCE);
extern void F484_3323(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F484_3326(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F484_3327(EIF_REFERENCE);
extern EIF_TYPED_VALUE F484_3328(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F484_3316 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 483, Current, 0, 0, 6093);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(483, Current, 6093);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F484_3317 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 483, Current, 0, 0, 6088);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(483, Current, 6088);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
...
/* {DYNAMIC_CHAIN}.prune */
void F484_3323 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 483, Current, 0, 1, 6089);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(483, Current, 6089);
	RTIV(Current, RTAL);
...
void F484_3326 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 483, Current, 0, 1, 6090);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(483, Current, 6090);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F484_3327 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 483, Current, 0, 0, 6091);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(483, Current, 6091);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F484_3328 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 483, Current, 2, 1, 6092);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(483, Current, 6092);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		uu1_1 = tu1_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2222, "extend", Result))(Result, uu1_1x);
		RTHOOK(9);
