...
extern EIF_TYPED_VALUE F462_4324(EIF_REFERENCE);
...
EIF_TYPED_VALUE F462_4324 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 461, Current, 0, 0, 8393);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(461, Current, 8393);
	RTIV(Current, RTAL);
