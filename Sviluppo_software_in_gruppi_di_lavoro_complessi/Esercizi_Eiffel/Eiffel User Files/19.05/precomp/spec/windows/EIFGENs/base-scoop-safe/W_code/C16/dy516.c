...
extern void F516_3470(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F516_3472(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F516_3473(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F516_3470 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 515, Current, 1, 1, 6237);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(515, Current, 6237);
	RTIV(Current, RTAL);
...
void F516_3472 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 515, Current, 0, 1, 6234);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(515, Current, 6234);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2258, "item", arg1))(arg1)).it_c1);
		uc1 = tc1;
...
void F516_3473 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 515, Current, 0, 1, 6235);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(515, Current, 6235);
	RTCC(arg1, 515, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F516_3477 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 515, Current, 0, 0, 6236);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(515, Current, 6236);
	RTIV(Current, RTAL);
	RTHOOK(1);
