...
extern EIF_TYPED_VALUE F498_2537(EIF_REFERENCE);
extern void F498_7146(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F498_2537 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 497, Current, 0, 0, 3371);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(497, Current, 3371);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F498_7146 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 497, Current, 0, 7145);
	RTSA(dtype);
	RTME(dtype, 0);
