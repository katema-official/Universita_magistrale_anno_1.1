...
extern void F509_4408(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F509_4409(EIF_REFERENCE);
extern EIF_TYPED_VALUE F509_4410(EIF_REFERENCE);
...
void F509_4408 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 508, Current, 0, 1, 9247);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(508, Current, 9247);
	RTCC(arg1, 508, l_feature_name, 1, RTWCT(3225, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3225, 0xF80001FA, 0); /* target */
	RTAR(Current, arg1);
...
EIF_TYPED_VALUE F509_4409 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F509_4410 (EIF_REFERENCE Current)
{
	GTCX
