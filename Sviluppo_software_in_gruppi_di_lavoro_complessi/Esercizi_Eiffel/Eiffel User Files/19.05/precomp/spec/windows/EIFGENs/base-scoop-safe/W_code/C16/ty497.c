...
extern EIF_TYPED_VALUE F497_4324(EIF_REFERENCE);
...
EIF_TYPED_VALUE F497_4324 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 496, Current, 0, 0, 8394);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(496, Current, 8394);
	RTIV(Current, RTAL);
