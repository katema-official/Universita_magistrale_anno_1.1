...
extern EIF_TYPED_VALUE F549_2537(EIF_REFERENCE);
extern void F549_7146(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F549_2537 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 548, Current, 0, 0, 3373);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(548, Current, 3373);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F549_7146 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 548, Current, 0, 7145);
	RTSA(dtype);
	RTME(dtype, 0);
