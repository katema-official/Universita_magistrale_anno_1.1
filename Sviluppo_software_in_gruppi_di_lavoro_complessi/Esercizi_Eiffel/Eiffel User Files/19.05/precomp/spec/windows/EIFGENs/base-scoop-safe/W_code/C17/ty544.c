...
extern EIF_TYPED_VALUE F544_4324(EIF_REFERENCE);
...
EIF_TYPED_VALUE F544_4324 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 543, Current, 0, 0, 8395);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(543, Current, 8395);
	RTIV(Current, RTAL);
