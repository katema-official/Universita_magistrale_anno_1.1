...
extern EIF_TYPED_VALUE F623_4324(EIF_REFERENCE);
...
EIF_TYPED_VALUE F623_4324 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 622, Current, 0, 0, 8396);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(622, Current, 8396);
	RTIV(Current, RTAL);
