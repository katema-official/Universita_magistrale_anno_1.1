...
extern EIF_TYPED_VALUE F62_1381(EIF_REFERENCE);
...
RTOID (F62_1381)
EIF_TYPED_VALUE F62_1381 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 61, Current, 0, 0, 1317);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(61, Current, 1317);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
