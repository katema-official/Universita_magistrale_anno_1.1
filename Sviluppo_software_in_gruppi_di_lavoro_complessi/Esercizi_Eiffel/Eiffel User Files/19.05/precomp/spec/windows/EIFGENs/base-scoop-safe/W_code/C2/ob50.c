...
extern EIF_TYPED_VALUE F50_1207(EIF_REFERENCE);
...
EIF_TYPED_VALUE F50_1207 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 49, Current, 0, 0, 1150);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(49, Current, 1150);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF800033D, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,829,0xFF05,0,0xFFFF};
		EIF_TYPE typres0;
