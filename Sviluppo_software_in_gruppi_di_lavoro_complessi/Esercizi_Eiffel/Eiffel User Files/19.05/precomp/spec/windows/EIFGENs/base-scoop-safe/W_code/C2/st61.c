...
extern void F61_1356(EIF_REFERENCE);
extern void F61_1357(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F61_1358(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F61_1362(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F61_1363(EIF_REFERENCE);
extern EIF_TYPED_VALUE F61_1364(EIF_REFERENCE);
extern void F61_1365(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F61_1366(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F61_1367(EIF_REFERENCE);
extern EIF_TYPED_VALUE F61_1368(EIF_REFERENCE);
extern EIF_TYPED_VALUE F61_1369(EIF_REFERENCE);
extern EIF_TYPED_VALUE F61_1370(EIF_REFERENCE);
extern EIF_TYPED_VALUE F61_1371(EIF_REFERENCE);
extern EIF_TYPED_VALUE F61_1372(EIF_REFERENCE);
extern EIF_TYPED_VALUE F61_1373(EIF_REFERENCE);
extern EIF_TYPED_VALUE F61_1374(EIF_REFERENCE);
extern EIF_TYPED_VALUE F61_1375(EIF_REFERENCE);
extern EIF_TYPED_VALUE F61_1376(EIF_REFERENCE);
extern EIF_TYPED_VALUE F61_1377(EIF_REFERENCE);
extern EIF_TYPED_VALUE F61_1378(EIF_REFERENCE);
extern EIF_TYPED_VALUE F61_1379(EIF_REFERENCE);
extern EIF_TYPED_VALUE F61_1380(EIF_REFERENCE);
...
void F61_1356 (EIF_REFERENCE Current)
{
	GTCX
...
void F61_1357 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 60, Current, 0, 1, 1310);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(60, Current, 1310);
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(1219, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	RTHOOK(3);
	RTDBGAA(Current, dtype, 1268, 0x3C000000, 1); /* part1 */
	*(EIF_NATURAL_64 *)(Current + RTWA(1268, dtype)) = (EIF_NATURAL_64) (EIF_NATURAL_64) ((EIF_INTEGER_32) 0L);
	RTHOOK(4);
	RTDBGAA(Current, dtype, 1269, 0x3C000000, 1); /* part2 */
	*(EIF_NATURAL_64 *)(Current + RTWA(1269, dtype)) = (EIF_NATURAL_64) (EIF_NATURAL_64) ((EIF_INTEGER_32) 0L);
	RTHOOK(5);
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(1211, dtype)) = (EIF_INTEGER_32) arg1;
	RTHOOK(7);
	RTDBGAA(Current, dtype, 1270, 0x04000000, 1); /* internal_overflowed */
	*(EIF_BOOLEAN *)(Current + RTWA(1270, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	if (RTAL & CK_ENSURE) {
		...
		tu8_1 = *(EIF_NATURAL_64 *)(Current + RTWA(1268, dtype));
		...
		tu8_1 = *(EIF_NATURAL_64 *)(Current + RTWA(1269, dtype));
		if ((EIF_BOOLEAN)(tu8_1 == (EIF_NATURAL_64) ((EIF_INTEGER_32) 0L))) {
			RTCK;
		} else {
			RTCF;
...
EIF_TYPED_VALUE F61_1358 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 60, Current, 4, 1, 1311);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(60, Current, 1311);
	RTCC(arg1, 60, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F61_1359 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 60, Current, 0, 0, 1312);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(60, Current, 1312);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(1270, dtype));
...
EIF_TYPED_VALUE F61_1360 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 60, Current, 0, 0, 1313);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(60, Current, 1313);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(1270, dtype));
...
EIF_TYPED_VALUE F61_1361 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 60, Current, 0, 0, 1314);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(60, Current, 1314);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(1219, dtype));
...
EIF_TYPED_VALUE F61_1362 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 60, Current, 0, 1, 1315);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(60, Current, 1315);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ui4_1 = arg1;
...
EIF_TYPED_VALUE F61_1363 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 60, Current, 0, 0, 1316);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(60, Current, 1316);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(1219, dtype));
...
EIF_TYPED_VALUE F61_1364 (EIF_REFERENCE Current)
{
	GTCX
...
void F61_1365 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 60, Current, 8, 2, 1293);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(60, Current, 1293);
	RTCC(arg1, 60, l_feature_name, 1, eif_new_type(229, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F61_1366 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 60, Current, 3, 1, 1294);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
		...
		switch (loc3) {
			case 0L:
				...
				if (tb1) {
					...
					*(EIF_NATURAL_64 *)(Current + RTWA(1269, dtype)) = (EIF_NATURAL_64) tu8_1;
				} else {
					RTHOOK(8);
				...
				if (tb1) {
					...
					*(EIF_NATURAL_64 *)(Current + RTWA(1269, dtype)) = (EIF_NATURAL_64) tu8_1;
					...
					if ((EIF_BOOLEAN)(ti4_1 != ti4_2)) {
						...
						tu8_1 = *(EIF_NATURAL_64 *)(Current + RTWA(1268, dtype));
						uu8_1 = tu8_1;
						tu8_2 = *(EIF_NATURAL_64 *)(Current + RTWA(1269, dtype));
						uu8_2 = tu8_2;
						ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(1211, dtype));
						ui4_1 = ti4_1;
					...
					if (tb1) {
						...
						*(EIF_BOOLEAN *)(Current + RTWA(1270, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
						RTHOOK(21);
						RTDBGAA(Current, dtype, 1268, 0x3C000000, 1); /* part1 */
						*(EIF_NATURAL_64 *)(Current + RTWA(1268, dtype)) = (EIF_NATURAL_64) loc1;
						RTHOOK(22);
						RTDBGAA(Current, dtype, 1269, 0x3C000000, 1); /* part2 */
						*(EIF_NATURAL_64 *)(Current + RTWA(1269, dtype)) = (EIF_NATURAL_64) loc2;
						RTHOOK(23);
						RTDBGAL(3, 0x10000000, 1, 0); /* loc3 */
			...
			case 2L:
				...
				if (tb1) {
					...
					tu8_1 = *(EIF_NATURAL_64 *)(Current + RTWA(1268, dtype));
					tu8_2 = *(EIF_NATURAL_64 *)(Current + RTWA(1269, dtype));
					*(EIF_NATURAL_64 *)(Current + RTWA(1268, dtype)) = (EIF_NATURAL_64) (EIF_NATURAL_64) ((EIF_NATURAL_64) (tu8_1 * (EIF_NATURAL_64) ((EIF_INTEGER_32) 10L)) + tu8_2);
					RTHOOK(29);
					RTDBGAA(Current, dtype, 1269, 0x3C000000, 1); /* part2 */
					ti4_1 = (EIF_INTEGER_32) (arg1);
					tu8_1 = (EIF_NATURAL_64) (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 48L));
					*(EIF_NATURAL_64 *)(Current + RTWA(1269, dtype)) = (EIF_NATURAL_64) tu8_1;
					...
					if ((EIF_BOOLEAN)(ti4_1 != ti4_2)) {
						...
						*(EIF_BOOLEAN *)(Current + RTWA(1270, dtype)) = (EIF_BOOLEAN) tb1;
						RTHOOK(32);
						tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1208, dtype))(Current)).it_b);
						if (tb1) {
							RTHOOK(33);
...
EIF_TYPED_VALUE F61_1367 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F61_1368 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F61_1369 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F61_1370 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F61_1371 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F61_1372 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F61_1373 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F61_1374 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F61_1375 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F61_1376 (EIF_REFERENCE Current)
{
	GTCX
...
RTOID (F61_1377)
EIF_TYPED_VALUE F61_1377 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F61_1378 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT64;
	r.it_n8 = *(EIF_NATURAL_64 *)(Current + RTWA(1268,Dtype(Current)));
	return r;
}


/* {STRING_TO_INTEGER_CONVERTOR}.part2 */
EIF_TYPED_VALUE F61_1379 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT64;
	r.it_n8 = *(EIF_NATURAL_64 *)(Current + RTWA(1269,Dtype(Current)));
	return r;
}


/* {STRING_TO_INTEGER_CONVERTOR}.internal_overflowed */
EIF_TYPED_VALUE F61_1380 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
