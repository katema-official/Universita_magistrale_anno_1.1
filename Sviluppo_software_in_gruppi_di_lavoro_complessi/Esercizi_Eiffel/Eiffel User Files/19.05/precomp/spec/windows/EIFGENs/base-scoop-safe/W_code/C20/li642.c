...
extern EIF_TYPED_VALUE F642_3331(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F642_3332(EIF_REFERENCE);
extern EIF_TYPED_VALUE F642_3333(EIF_REFERENCE);
extern void F642_7169(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F642_3331 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 641, Current, 2, 1, 6183);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tr8_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2258, "item", arg1))(arg1)).it_r8);
...
/* {LIST}.after */
EIF_TYPED_VALUE F642_3332 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 641, Current, 0, 0, 6184);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {LIST}.before */
EIF_TYPED_VALUE F642_3333 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 641, Current, 0, 0, 6185);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {LIST}._invariant */
void F642_7169 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 641, Current, 0, 7168);
	RTSA(dtype);
	RTME(dtype, 0);
