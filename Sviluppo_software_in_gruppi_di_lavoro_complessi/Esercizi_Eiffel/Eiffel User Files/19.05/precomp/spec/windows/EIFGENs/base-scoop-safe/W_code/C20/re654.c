...
extern void F654_7162(EIF_REFERENCE, int);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 653, Current, 0, 0, 3993);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(653, Current, 3993);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 653, Current, 0, 0, 3994);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(653, Current, 3994);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F654_7162 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 653, Current, 0, 7161);
	RTSA(dtype);
	RTME(dtype, 0);
