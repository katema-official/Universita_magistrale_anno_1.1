...
extern EIF_TYPED_VALUE F659_4324(EIF_REFERENCE);
...
EIF_TYPED_VALUE F659_4324 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 658, Current, 0, 0, 8397);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(658, Current, 8397);
	RTIV(Current, RTAL);
