...
extern EIF_TYPED_VALUE F682_3316(EIF_REFERENCE);
extern EIF_TYPED_VALUE F682_3317(EIF_REFERENCE);
extern void F682_3323(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F682_3326(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F682_3327(EIF_REFERENCE);
extern EIF_TYPED_VALUE F682_3328(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F682_3316 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 681, Current, 0, 0, 6117);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 6117);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F682_3317 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 681, Current, 0, 0, 6112);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 6112);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
...
/* {DYNAMIC_CHAIN}.prune */
void F682_3323 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 681, Current, 0, 1, 6113);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 6113);
	RTIV(Current, RTAL);
...
void F682_3326 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 681, Current, 0, 1, 6114);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 6114);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F682_3327 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 681, Current, 0, 0, 6115);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 6115);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F682_3328 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 681, Current, 2, 1, 6116);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 6116);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		ui1_1 = ti1_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2222, "extend", Result))(Result, ui1_1x);
		RTHOOK(9);
