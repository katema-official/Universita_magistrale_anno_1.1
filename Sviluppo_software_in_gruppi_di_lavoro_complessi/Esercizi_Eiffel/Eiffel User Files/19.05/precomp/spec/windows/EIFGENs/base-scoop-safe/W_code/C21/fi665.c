...
extern EIF_TYPED_VALUE F665_2537(EIF_REFERENCE);
extern void F665_7146(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F665_2537 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 664, Current, 0, 0, 3377);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(664, Current, 3377);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F665_7146 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 664, Current, 0, 7145);
	RTSA(dtype);
	RTME(dtype, 0);
