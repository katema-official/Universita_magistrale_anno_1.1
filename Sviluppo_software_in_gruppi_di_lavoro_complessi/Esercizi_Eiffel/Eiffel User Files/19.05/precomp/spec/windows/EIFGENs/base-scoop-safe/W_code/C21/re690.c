...
extern EIF_TYPED_VALUE F690_3077(EIF_REFERENCE);
extern EIF_TYPED_VALUE F690_3080(EIF_REFERENCE);
extern void F690_7162(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F690_3077 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 689, Current, 0, 0, 3996);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(689, Current, 3996);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F690_3080 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 689, Current, 0, 0, 3997);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(689, Current, 3997);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F690_7162 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 689, Current, 0, 7161);
	RTSA(dtype);
	RTME(dtype, 0);
