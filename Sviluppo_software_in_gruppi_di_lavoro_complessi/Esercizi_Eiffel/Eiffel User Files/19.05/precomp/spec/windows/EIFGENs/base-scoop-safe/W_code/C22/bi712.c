...
extern EIF_TYPED_VALUE F712_2710(EIF_REFERENCE);
extern void F712_2713(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F712_7156(EIF_REFERENCE, int);
...
/* {BILINEAR}.off */
EIF_TYPED_VALUE F712_2710 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 711, Current, 0, 0, 3821);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(711, Current, 3821);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 711, Current, 0, 1, 3822);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(711, Current, 3822);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2359, dtype))(Current)).it_b);
	...
	RTHOOK(3);
	ui2_1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2301, 702))(Current, ui2_1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
/* {BILINEAR}._invariant */
void F712_7156 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 711, Current, 0, 7155);
	RTSA(dtype);
	RTME(dtype, 0);
