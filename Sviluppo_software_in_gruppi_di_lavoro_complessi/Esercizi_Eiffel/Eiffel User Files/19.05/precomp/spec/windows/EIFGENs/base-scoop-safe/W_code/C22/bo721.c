...
extern EIF_TYPED_VALUE F721_2551(EIF_REFERENCE);
extern void F721_7148(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F721_2551 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 720, Current, 0, 0, 3422);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(720, Current, 3422);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F721_7148 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 720, Current, 0, 7147);
	RTSA(dtype);
	RTME(dtype, 0);
