...
extern void F713_3470(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F713_3472(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F713_3473(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F713_3477(EIF_REFERENCE);
...
void F713_3470 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 712, Current, 1, 1, 6253);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(712, Current, 6253);
	RTIV(Current, RTAL);
...
body:;
	...
	if (tb1) {
		RTHOOK(4);
		ui2_1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2706, dtype))(Current, ui2_1x);
	} else {
		RTHOOK(5);
...
void F713_3472 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 712, Current, 0, 1, 6250);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(712, Current, 6250);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		ti2_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2258, "item", arg1))(arg1)).it_i2);
		ui2_1 = ti2_1;
...
void F713_3473 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 712, Current, 0, 1, 6251);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(712, Current, 6251);
	RTCC(arg1, 712, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F713_3477 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 712, Current, 0, 0, 6252);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(712, Current, 6252);
	RTIV(Current, RTAL);
	RTHOOK(1);
