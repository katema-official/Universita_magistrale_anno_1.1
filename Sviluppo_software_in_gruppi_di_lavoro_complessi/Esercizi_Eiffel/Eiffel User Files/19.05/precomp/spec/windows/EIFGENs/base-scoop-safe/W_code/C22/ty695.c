...
extern EIF_TYPED_VALUE F695_4324(EIF_REFERENCE);
...
EIF_TYPED_VALUE F695_4324 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 694, Current, 0, 0, 8398);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(694, Current, 8398);
	RTIV(Current, RTAL);
