...
extern EIF_TYPED_VALUE F739_3316(EIF_REFERENCE);
extern EIF_TYPED_VALUE F739_3317(EIF_REFERENCE);
extern void F739_3323(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F739_3326(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F739_3327(EIF_REFERENCE);
extern EIF_TYPED_VALUE F739_3328(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F739_3316 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 738, Current, 0, 0, 6129);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(738, Current, 6129);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F739_3317 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 738, Current, 0, 0, 6124);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(738, Current, 6124);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
...
/* {DYNAMIC_CHAIN}.prune */
void F739_3323 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 738, Current, 0, 1, 6125);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(738, Current, 6125);
	RTIV(Current, RTAL);
...
void F739_3326 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 738, Current, 0, 1, 6126);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(738, Current, 6126);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F739_3327 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 738, Current, 0, 0, 6127);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(738, Current, 6127);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F739_3328 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 738, Current, 2, 1, 6128);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(738, Current, 6128);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
