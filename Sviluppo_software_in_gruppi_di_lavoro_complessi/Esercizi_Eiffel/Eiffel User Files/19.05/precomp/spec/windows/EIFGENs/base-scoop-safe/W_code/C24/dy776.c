...
extern EIF_TYPED_VALUE F776_3316(EIF_REFERENCE);
extern EIF_TYPED_VALUE F776_3317(EIF_REFERENCE);
extern void F776_3323(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F776_3326(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F776_3327(EIF_REFERENCE);
extern EIF_TYPED_VALUE F776_3328(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F776_3316 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 775, Current, 0, 0, 6135);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(775, Current, 6135);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F776_3317 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 775, Current, 0, 0, 6130);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(775, Current, 6130);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
...
/* {DYNAMIC_CHAIN}.prune */
void F776_3323 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui8_1 ui8_1x.it_i8
	...
	RTEAA(l_feature_name, 775, Current, 0, 1, 6131);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(775, Current, 6131);
	RTIV(Current, RTAL);
...
void F776_3326 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui8_1 ui8_1x.it_i8
	...
	RTEAA(l_feature_name, 775, Current, 0, 1, 6132);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(775, Current, 6132);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F776_3327 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 775, Current, 0, 0, 6133);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(775, Current, 6133);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F776_3328 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui8_1 ui8_1x.it_i8
	...
	RTEAA(l_feature_name, 775, Current, 2, 1, 6134);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(775, Current, 6134);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		ui8_1 = ti8_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2222, "extend", Result))(Result, ui8_1x);
		RTHOOK(9);
