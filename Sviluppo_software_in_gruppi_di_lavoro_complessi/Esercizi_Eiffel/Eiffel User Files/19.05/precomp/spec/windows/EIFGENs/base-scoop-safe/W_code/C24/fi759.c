...
extern EIF_TYPED_VALUE F759_2537(EIF_REFERENCE);
extern void F759_7146(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F759_2537 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 758, Current, 0, 0, 3381);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(758, Current, 3381);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F759_7146 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 758, Current, 0, 7145);
	RTSA(dtype);
	RTME(dtype, 0);
