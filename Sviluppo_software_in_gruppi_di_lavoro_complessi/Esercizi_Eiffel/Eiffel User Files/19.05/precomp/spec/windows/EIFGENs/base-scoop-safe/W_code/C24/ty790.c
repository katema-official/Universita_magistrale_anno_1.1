...
extern EIF_TYPED_VALUE F790_4324(EIF_REFERENCE);
...
EIF_TYPED_VALUE F790_4324 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 789, Current, 0, 0, 8400);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(789, Current, 8400);
	RTIV(Current, RTAL);
