...
extern EIF_TYPED_VALUE F815_2551(EIF_REFERENCE);
extern void F815_7148(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F815_2551 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 814, Current, 0, 0, 3428);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(814, Current, 3428);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F815_7148 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 814, Current, 0, 7147);
	RTSA(dtype);
	RTME(dtype, 0);
