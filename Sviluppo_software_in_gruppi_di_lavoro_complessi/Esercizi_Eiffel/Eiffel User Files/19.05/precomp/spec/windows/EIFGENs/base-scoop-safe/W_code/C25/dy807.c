...
extern void F807_3470(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F807_3472(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F807_3473(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F807_3477(EIF_REFERENCE);
...
void F807_3470 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 806, Current, 1, 1, 6265);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(806, Current, 6265);
	RTIV(Current, RTAL);
...
void F807_3472 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 806, Current, 0, 1, 6262);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(806, Current, 6262);
	RTCC(arg1, 806, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
void F807_3473 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 806, Current, 0, 1, 6263);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(806, Current, 6263);
	RTCC(arg1, 806, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F807_3477 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 806, Current, 0, 0, 6264);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(806, Current, 6264);
	RTIV(Current, RTAL);
	RTHOOK(1);
