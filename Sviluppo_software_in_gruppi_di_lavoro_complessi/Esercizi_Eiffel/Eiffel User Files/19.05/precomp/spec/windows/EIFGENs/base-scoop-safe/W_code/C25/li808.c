...
extern EIF_TYPED_VALUE F808_3331(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F808_3332(EIF_REFERENCE);
extern EIF_TYPED_VALUE F808_3333(EIF_REFERENCE);
extern void F808_7169(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F808_3331 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 807, Current, 2, 1, 6203);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(807, Current, 6203);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2258, "item", arg1))(arg1)).it_b);
...
/* {LIST}.after */
EIF_TYPED_VALUE F808_3332 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 807, Current, 0, 0, 6204);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(807, Current, 6204);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F808_3333 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 807, Current, 0, 0, 6205);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(807, Current, 6205);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2302, dtype))(Current)).it_i4);
...
/* {LIST}._invariant */
void F808_7169 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 807, Current, 0, 7168);
	RTSA(dtype);
	RTME(dtype, 0);
