...
extern void F830_4153(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F830_4154(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F830_4155(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F830_4156(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F830_4157(EIF_REFERENCE);
extern EIF_TYPED_VALUE F830_4158(EIF_REFERENCE);
...
void F830_4153 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 829, Current, 1, 1, 8235);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(829, Current, 8235);
	{
...
void F830_4154 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 829, Current, 0, 1, 8230);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(829, Current, 8230);
	RTCC(arg1, 829, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
/* {ARRAYED_STACK}.put */
void F830_4155 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 829, Current, 0, 1, 8231);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(829, Current, 8231);
	RTCC(arg1, 829, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
/* {ARRAYED_STACK}.force */
void F830_4156 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 829, Current, 0, 1, 8232);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(829, Current, 8232);
	RTCC(arg1, 829, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F830_4157 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 829, Current, 0, 0, 8233);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(829, Current, 8233);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F830_4158 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 829, Current, 1, 0, 8234);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(829, Current, 8234);
	RTIV(Current, RTAL);
	RTHOOK(1);
