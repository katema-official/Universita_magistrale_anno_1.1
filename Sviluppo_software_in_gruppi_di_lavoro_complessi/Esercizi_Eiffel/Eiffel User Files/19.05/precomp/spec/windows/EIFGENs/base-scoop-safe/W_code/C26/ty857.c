...
extern EIF_TYPED_VALUE F857_4324(EIF_REFERENCE);
...
EIF_TYPED_VALUE F857_4324 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 856, Current, 0, 0, 8401);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(856, Current, 8401);
	RTIV(Current, RTAL);
