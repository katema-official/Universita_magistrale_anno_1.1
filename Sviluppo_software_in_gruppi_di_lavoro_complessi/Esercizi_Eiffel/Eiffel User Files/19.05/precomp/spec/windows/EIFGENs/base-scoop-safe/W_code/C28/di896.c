...
extern EIF_TYPED_VALUE F896_2538(EIF_REFERENCE);
extern EIF_TYPED_VALUE F896_2539(EIF_REFERENCE);
extern void F896_2540(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F896_7147(EIF_REFERENCE, int);
...
/* {DISPENSER}.readable */
EIF_TYPED_VALUE F896_2538 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 895, Current, 0, 0, 3391);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(895, Current, 3391);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {DISPENSER}.writable */
EIF_TYPED_VALUE F896_2539 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 895, Current, 0, 0, 3392);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(895, Current, 3392);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2210, dtype))(Current)).it_b);
...
/* {DISPENSER}.append */
void F896_2540 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 895, Current, 0, 1, 3393);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(895, Current, 3393);
	{
...
void F896_7147 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 895, Current, 0, 7146);
	RTSA(dtype);
	RTME(dtype, 0);
