...
extern EIF_TYPED_VALUE F904_2538(EIF_REFERENCE);
extern EIF_TYPED_VALUE F904_2539(EIF_REFERENCE);
extern void F904_2540(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F904_7147(EIF_REFERENCE, int);
...
/* {DISPENSER}.readable */
EIF_TYPED_VALUE F904_2538 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 903, Current, 0, 0, 3395);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(903, Current, 3395);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {DISPENSER}.writable */
EIF_TYPED_VALUE F904_2539 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 903, Current, 0, 0, 3396);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(903, Current, 3396);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2210, dtype))(Current)).it_b);
...
/* {DISPENSER}.append */
void F904_2540 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 903, Current, 0, 1, 3397);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(903, Current, 3397);
	{
...
void F904_7147 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 903, Current, 0, 7146);
	RTSA(dtype);
	RTME(dtype, 0);
