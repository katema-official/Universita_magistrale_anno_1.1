...
extern void F922_3470(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F922_3472(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F922_3473(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F922_3477(EIF_REFERENCE);
...
void F922_3470 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 921, Current, 1, 1, 6273);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(921, Current, 6273);
	RTIV(Current, RTAL);
...
void F922_3472 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 921, Current, 0, 1, 6270);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(921, Current, 6270);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tw1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2258, "item", arg1))(arg1)).it_c4);
		uw1 = tw1;
...
void F922_3473 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 921, Current, 0, 1, 6271);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(921, Current, 6271);
	RTCC(arg1, 921, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F922_3477 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 921, Current, 0, 0, 6272);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(921, Current, 6272);
	RTIV(Current, RTAL);
	RTHOOK(1);
