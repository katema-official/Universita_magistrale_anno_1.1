...
extern void F891_3561(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F891_3562(EIF_REFERENCE);
extern void F891_3563(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F891_3564(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F891_3565(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F891_3566(EIF_REFERENCE);
extern EIF_TYPED_VALUE F891_3567(EIF_REFERENCE);
extern EIF_TYPED_VALUE F891_3568(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F891_3561 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 890, Current, 1, 1, 6419);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(890, Current, 6419);
	{
...
/* {LINKED_STACK}.item */
EIF_TYPED_VALUE F891_3562 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 890, Current, 1, 0, 6420);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(890, Current, 6420);
	RTIV(Current, RTAL);
	if (RTAL & CK_CHECK) {
		RTHOOK(1);
...
/* {LINKED_STACK}.force */
void F891_3563 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 890, Current, 0, 1, 6421);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(890, Current, 6421);
	RTIV(Current, RTAL);
...
/* {LINKED_STACK}.extend */
void F891_3564 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 890, Current, 0, 1, 6422);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(890, Current, 6422);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
/* {LINKED_STACK}.put */
void F891_3565 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 890, Current, 0, 1, 6415);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(890, Current, 6415);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ub1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2706, dtype))(Current, ub1x);
...
/* {LINKED_STACK}.remove */
void F891_3566 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 890, Current, 0, 0, 6416);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(890, Current, 6416);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F891_3567 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 890, Current, 1, 0, 6417);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(890, Current, 6417);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F891_3568 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 890, Current, 3, 1, 6418);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(890, Current, 6418);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	if ((EIF_BOOLEAN) !tb1) {
		...
		for (;;) {
			...
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2777, dtype))(Current)).it_b);
			ub1 = tb2;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2708, "put_right", loc3))(loc3, ub1x);
			RTHOOK(12);
