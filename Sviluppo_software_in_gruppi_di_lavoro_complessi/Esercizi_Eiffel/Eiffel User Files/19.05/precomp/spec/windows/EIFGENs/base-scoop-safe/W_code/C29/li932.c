...
extern EIF_TYPED_VALUE F932_1936(EIF_REFERENCE);
extern void F932_1937(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F932_1938(EIF_REFERENCE);
...
/* {LINKABLE}.right */
EIF_TYPED_VALUE F932_1936 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {LINKABLE}.put_right */
void F932_1937 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 931, Current, 0, 1, 1882);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(931, Current, 1882);
	RTCC(arg1, 931, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1722, 0xF80003A3, 0); /* right */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
void F932_1938 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 931, Current, 0, 0, 1883);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(931, Current, 1883);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1722, 0xF80003A3, 0); /* right */
