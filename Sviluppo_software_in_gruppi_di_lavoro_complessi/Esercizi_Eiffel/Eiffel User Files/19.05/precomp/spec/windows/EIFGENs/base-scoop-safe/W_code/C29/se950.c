...
extern EIF_TYPED_VALUE F950_2482(EIF_REFERENCE);
...
EIF_TYPED_VALUE F950_2482 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 949, Current, 0, 0, 3304);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(949, Current, 3304);
	RTIV(Current, RTAL);
	RTHOOK(1);
