...
extern EIF_TYPED_VALUE F77_1483(EIF_REFERENCE);
extern EIF_TYPED_VALUE F77_1484(EIF_REFERENCE);
...
EIF_TYPED_VALUE F77_1483 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 76, Current, 0, 0, 1419);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(846, 30))(Current)).it_i4);
...
RTOID (F77_1484)
EIF_TYPED_VALUE F77_1484 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 76, Current, 0, 0, 1420);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
