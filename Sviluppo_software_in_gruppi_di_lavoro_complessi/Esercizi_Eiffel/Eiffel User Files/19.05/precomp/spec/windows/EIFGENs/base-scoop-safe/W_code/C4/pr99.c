...
EIF_TYPED_VALUE F99_1525 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 98, Current, 0, 0, 1461);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(98, Current, 1461);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(829, 30))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 98, Current, 0, 0, 1462);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(98, Current, 1462);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
