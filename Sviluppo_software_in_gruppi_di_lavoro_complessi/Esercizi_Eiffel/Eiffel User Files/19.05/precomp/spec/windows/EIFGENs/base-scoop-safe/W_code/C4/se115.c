...
extern void F115_1682(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F115_1682 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 114, Current, 8, 1, 1612);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(114, Current, 1612);
	RTIV(Current, RTAL);
	RTHOOK(1);
