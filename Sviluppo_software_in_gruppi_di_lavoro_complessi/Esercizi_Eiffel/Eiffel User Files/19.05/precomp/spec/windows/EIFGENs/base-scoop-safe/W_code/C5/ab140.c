...
extern EIF_TYPED_VALUE F140_2308(EIF_REFERENCE);
extern void F140_7138(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F140_2308 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 139, Current, 0, 0, 2239);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(139, Current, 2239);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F140_7138 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 139, Current, 0, 7137);
	RTSA(dtype);
	RTME(dtype, 0);
