...
extern void F157_3856(EIF_REFERENCE);
extern EIF_TYPED_VALUE F157_3857(EIF_REFERENCE);
...
void F157_3856 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 156, Current, 2, 0, 6564);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(156, Current, 6564);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(4);
	ur1 = RTCCL(loc1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1291, "raise_retrieval_exception", loc2))(loc2, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
...
RTOID (F157_3857)
EIF_TYPED_VALUE F157_3857 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 156, Current, 0, 0, 6565);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(156, Current, 6565);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
