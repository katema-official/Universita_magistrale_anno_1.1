...
extern void F168_4396(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F168_4397(EIF_REFERENCE);
extern EIF_TYPED_VALUE F168_4398(EIF_REFERENCE);
extern EIF_TYPED_VALUE F168_4399(EIF_REFERENCE);
extern EIF_TYPED_VALUE F168_4400(EIF_REFERENCE);
extern EIF_TYPED_VALUE F168_4401(EIF_REFERENCE);
...
void F168_4396 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 167, Current, 1, 1, 9131);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(167, Current, 9131);
	RTCC(arg1, 167, l_feature_name, 1, RTWCT(3236, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3236, 0xF80000E6, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(3236, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 3225, 0xF80001FA, 0); /* area */
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(3226, dtype)) = (EIF_INTEGER_32) loc1;
	RTHOOK(6);
	RTDBGAA(Current, dtype, 3235, 0x10000000, 1); /* area_first_index */
	*(EIF_INTEGER_32 *)(Current + RTWA(3235, dtype)) = (EIF_INTEGER_32) loc1;
	RTHOOK(7);
...
EIF_TYPED_VALUE F168_4397 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F168_4398 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 167, Current, 0, 0, 9133);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(167, Current, 9133);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80000A7, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(167, 0x01).id);
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3236, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F168_4399 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 167, Current, 0, 0, 9134);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(167, Current, 9134);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tr2 == tr1)) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3208, 505))(Current)).it_b);
		tb1 = tb2;
	}
...
EIF_TYPED_VALUE F168_4400 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F168_4401 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(3235,Dtype(Current)));
	return r;
}
