...
extern EIF_TYPED_VALUE F261_4324(EIF_REFERENCE);
...
EIF_TYPED_VALUE F261_4324 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 260, Current, 0, 0, 8387);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(260, Current, 8387);
	RTIV(Current, RTAL);
