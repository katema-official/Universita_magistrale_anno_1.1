...
extern void F281_4384(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F281_4385(EIF_REFERENCE);
...
void F281_4384 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 280, Current, 0, 1, 9035);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(280, Current, 9035);
	RTCC(arg1, 280, l_feature_name, 1, RTWCT(3230, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3230, 0xF800010E, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
EIF_TYPED_VALUE F281_4385 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 280, Current, 0, 0, 9037);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(280, Current, 9037);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 280, Current, 0, 0, 9038);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(280, Current, 9038);
	RTIV(Current, RTAL);
	RTHOOK(1);
