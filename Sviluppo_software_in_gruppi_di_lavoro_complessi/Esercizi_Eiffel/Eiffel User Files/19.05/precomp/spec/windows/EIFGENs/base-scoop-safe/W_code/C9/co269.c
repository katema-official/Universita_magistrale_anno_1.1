...
extern EIF_TYPED_VALUE F269_2471(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F269_2474(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F269_2476(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F269_2471 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 268, Current, 0, 1, 3259);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(268, Current, 3259);
	RTCC(arg1, 268, l_feature_name, 1, RTWCT(2164, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {COLLECTION}.fill */
void F269_2474 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 268, Current, 1, 1, 3260);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(268, Current, 3260);
	{
...
void F269_2476 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 268, Current, 0, 1, 3261);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(268, Current, 3261);
	RTCC(arg1, 268, l_feature_name, 1, RTWCT(2164, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
