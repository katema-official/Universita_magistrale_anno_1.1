...
extern EIF_TYPED_VALUE F285_3331(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F285_3332(EIF_REFERENCE);
extern EIF_TYPED_VALUE F285_3333(EIF_REFERENCE);
extern void F285_7169(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F285_3331 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 284, Current, 2, 1, 6155);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(284, Current, 6155);
...
body:;
	if (RTAL & CK_ENSURE) {
		...
		RTE_OE
		RTE_OT
		ti4_3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2302, "index", arg1))(arg1)).it_i4);
		ti4_2 = ti4_3;
		tr2 = NULL;
		RTE_O
		tr2 = RTLA;
	...
	if (RTCEQ(Current, arg1)) {
		...
		if (tb1) {
			...
			loc1 = RTCCL(tr3);
			if (EIF_TEST(loc1)) {
				tr3 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2264, "cursor", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
				loc2 = RTCCL(tr3);
				tb1 = EIF_TEST(loc2);
			}
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tr4 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2258, "item", arg1))(arg1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
...
/* {LIST}.after */
EIF_TYPED_VALUE F285_3332 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 284, Current, 0, 0, 6156);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(284, Current, 6156);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F285_3333 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 284, Current, 0, 0, 6157);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(284, Current, 6157);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2302, dtype))(Current)).it_i4);
...
/* {LIST}._invariant */
void F285_7169 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 284, Current, 0, 7168);
	RTSA(dtype);
	RTME(dtype, 0);
