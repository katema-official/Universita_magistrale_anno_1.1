...
void egc_init_plug (void)
{
	...
	egc_system_name = "precomp_base-scoop-safe";
	egc_system_location = "c:\\users\\aless\\onedrive\\documenti\\eiffel user files\\19.05\\precomp\\spec\\windows\\EIFGENs\\base-scoop-safe\\W_code";
	egc_compiler_tag = 38;
