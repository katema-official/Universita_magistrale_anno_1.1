...
static const EIF_TYPE_INDEX egt_13_1024 [] = {0xFF01,232,0xFFFF};
...
static const struct desc_info desc_1024[] = {
	...
	{EIF_GENERIC(egt_13_1024), 14500, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 14503, 0},
...
void Init1024(void)
{
	...
	IDSC(desc_1024 + 32, 260, 1023);
	IDSC(desc_1024 + 34, 401, 1023);
	IDSC(desc_1024 + 37, 400, 1023);
}
