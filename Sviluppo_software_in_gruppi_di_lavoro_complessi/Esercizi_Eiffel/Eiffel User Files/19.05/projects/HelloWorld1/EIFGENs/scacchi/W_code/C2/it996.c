...
extern void F996_7523(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F996_7524(EIF_REFERENCE);
extern EIF_TYPED_VALUE F996_7525(EIF_REFERENCE);
extern void F996_7526(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {ITP_CONSTANT}.make */
void F996_7523 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 995, Current, 0, 1, 13784);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(995, Current, 13784);
	RTCC(arg1, 995, l_feature_name, 1, RTWCT(5278, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5278, 0xF8000000, 0); /* value */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
/* {ITP_CONSTANT}.value */
EIF_TYPED_VALUE F996_7524 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 995, Current, 1, 0, 13786);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(995, Current, 13786);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F996_7526 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTCC(arg1, 995, l_feature_name, 1, eif_new_type(960, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5007, "process_constant", arg1))(arg1, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
