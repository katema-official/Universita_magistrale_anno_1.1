...
void egc_init_plug (void)
{
	...
	egc_system_name = "scacchi";
	egc_system_location = "C:\\Users\\aless\\OneDrive\\Desktop\\Universita_magistrale_anno_1.1\\Sviluppo_software_in_gruppi_di_lavoro_complessi\\Esercizi_Eiffel\\Eiffel User Files\\19.05\\projects\\HelloWorld1\\EIFGENs\\scacchi\\W_code";
	egc_compiler_tag = 38;
...
{
	if (egc_rcdt[0] == 0) {
		egc_rcdt[0] = 1009; /* APPLICATION */
	}if (egc_rcdt[1] == 0) {
		egc_rcdt[1] = 1010; /* EQA_EVALUATOR */
	}if (egc_rcdt[2] == 0) {
		egc_rcdt[2] = 1034; /* ITP_INTERPRETER */
	}
}
