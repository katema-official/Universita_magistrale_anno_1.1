...
extern EIF_TYPED_VALUE F987_7480(EIF_REFERENCE);
...
EIF_TYPED_VALUE F987_7480 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 986, Current, 0, 0, 13745);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(986, Current, 13745);
	RTIV(Current, RTAL);
	RTHOOK(1);
