...
void egc_init_plug (void)
{
	...
	egc_system_name = "katabowling";
	egc_system_location = "C:\\Users\\aless\\OneDrive\\Documenti\\Eiffel User Files\\19.05\\projects\\KataBowling\\EIFGENs\\katabowling\\W_code";
	egc_compiler_tag = 38;
...
void egc_rcdt_init (void)
{
	if (egc_rcdt[0] == 0) {
		...
		egc_rcdt[1] = 1007; /* EQA_EVALUATOR */
	}if (egc_rcdt[2] == 0) {
		egc_rcdt[2] = 1031; /* ITP_INTERPRETER */
	}
}
