...
extern EIF_TYPED_VALUE F972_7350(EIF_REFERENCE);
...
EIF_TYPED_VALUE F972_7350 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT64;
...
#define arg1 arg1x.it_n8
	...
	RTEAA(l_feature_name, 971, Current, 1, 1, 13653);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 971, Current, 0, 1, 13654);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define arg1 arg1x.it_n8
	...
	RTEAA(l_feature_name, 971, Current, 0, 1, 13655);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
