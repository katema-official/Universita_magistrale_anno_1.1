/*
 * Code for class ARRAYED_QUEUE_ITERATION_CURSOR [CHARACTER_8]
 */
...
extern void F1040_4283(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1040_4284(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1040_4285(EIF_REFERENCE);
extern void F1040_4286(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1040_4287(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1040_4288(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1040_4289(EIF_REFERENCE);
...
void F1040_4283 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1039, Current, 0, 1, 14176);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1039, Current, 14176);
	{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 3184, 0xF80001FA, 0); /* area */
	...
	*(EIF_REFERENCE *)(Current + RTWA(3184, dtype)) = (EIF_REFERENCE) tr1;
	...
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2966, 1038))(Current)).it_i4);
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(3186, dtype)) = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		...
		ti4_3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2966, 1038))(Current)).it_i4);
...
EIF_TYPED_VALUE F1040_4284 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1039, Current, 0, 0, 14177);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1039, Current, 14177);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1040_4285 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1039, Current, 0, 0, 14178);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1039, Current, 14178);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1040_4286 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1039, Current, 0, 0, 14179);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1039, Current, 14179);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_position", EX_PRE);
...
EIF_TYPED_VALUE F1040_4287 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1040_4288 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1040_4289 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
