/*
 * Code for class BOUNDED_QUEUE [INTEGER_32]
 */
...
extern EIF_TYPED_VALUE F1033_3922(EIF_REFERENCE);
extern void F1033_3923(EIF_REFERENCE);
extern void F1033_7178(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1033_3922 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1032, Current, 0, 0, 14270);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1032, Current, 14270);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1033_3923 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1032, Current, 6, 0, 14271);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1032, Current, 14271);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = '\0';
	...
	if (tb1) {
		...
		*(EIF_INTEGER_32 *)(Current + RTWA(2964, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
		...
		tr1 = RTLNSP2(RTWCT(2963, dtype, dftype).id,0,ui4_1,sizeof(EIF_INTEGER_32), EIF_TRUE);
		...
		*(EIF_REFERENCE *)(Current + RTWA(2963, dtype)) = (EIF_REFERENCE) tr1;
		...
		if ((EIF_BOOLEAN) (loc5 > loc4)) {
			...
			for (;;) {
				...
				RTHOOK(8);
				ui4_2 = loc1;
				ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2252, "item", loc3))(loc3, ui4_2x)).it_i4);
				ui4_2 = ti4_2;
				(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2222, dtype))(Current, ui4_2x);
				RTHOOK(9);
				RTDBGAL(1, 0x10000000, 1, 0); /* loc1 */
				loc1++;
			}
		...
		*(EIF_BOOLEAN *)(Current + RTWA(2212, dtype)) = (EIF_BOOLEAN) loc6;
		...
		RTHOOK(19);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(2934, 1033))(Current);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(20);
...
void F1033_7178 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1032, Current, 0, 7177);
	RTSA(dtype);
	RTME(dtype, 0);
