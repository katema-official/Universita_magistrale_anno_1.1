/*
 * Code for class DISPENSER [CHARACTER_8]
 */
...
extern EIF_TYPED_VALUE F1042_2538(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1042_2539(EIF_REFERENCE);
extern void F1042_2540(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1042_7147(EIF_REFERENCE, int);
...
/* {DISPENSER}.readable */
EIF_TYPED_VALUE F1042_2538 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1041, Current, 0, 0, 14117);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {DISPENSER}.writable */
EIF_TYPED_VALUE F1042_2539 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1041, Current, 0, 0, 14118);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {DISPENSER}.append */
void F1042_2540 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1041, Current, 0, 1, 14119);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1042_7147 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1041, Current, 0, 7146);
	RTSA(dtype);
	RTME(dtype, 0);
