...
extern EIF_TYPED_VALUE F1031_7853(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1031_7854(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1031_7855(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1031_8496(EIF_REFERENCE);
extern void EIF_Minit1031(void);
extern EIF_REFERENCE _A969_39();
extern EIF_REFERENCE _A251_140();
extern EIF_REFERENCE _A1031_270();
...
RTOID (F1031_7853)
EIF_TYPED_VALUE F1031_7853 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1030, Current, 0, 0, 14085);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1030, Current, 14085);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(5786, Dtype(tr1)))(tr1, ui4_1x);
	RTNHOOK(1,1);
...
EIF_TYPED_VALUE F1031_7854 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur5 ur5x.it_r
	...
	RTEAA(l_feature_name, 1030, Current, 8, 1, 14086);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1030, Current, 14086);
	{
	...
	
	{
		...
		{
			EIF_TYPE l_type;
			l_type = RTWCT(5545, dtype, dftype);
			typarr0[6] = l_type.annotations | 0xFF00;
			typarr0[7] = l_type.id;
		}
		
		typres0 = eif_compound_id(dftype, typarr0);
		tr2= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1031_270, (EIF_POINTER)(0),6023, 0, 0, 1, 1030, tr1, 0);
	}
	...
	RTHOOK(7);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5053, "is_exceptional", loc3))(loc3)).it_b);
	if ((EIF_BOOLEAN) !tb2) {
	...
	if (tb1) {
		if (RTAL & CK_CHECK) {
			...
			{
				static EIF_TYPE_INDEX typarr0[] = {0xFF01,0xFFF9,1,186,0xFF01,968,0xFFFF};
				EIF_TYPE typres0;
				static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
		...
		{
			static EIF_TYPE_INDEX typarr0[] = {0xFFF9,2,186,0xFF01,250,0xFF01,0xFFF9,1,186,0xFF01,968,0xFF04,0xFFF9,1,186,0xFF01,968,0xFFFF};
			EIF_TYPE typres0;
			static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
		...
		RTHOOK(11);
		RTDBGAL(5, 0xF80003C4, 0, 0); /* loc5 */
		{
			static EIF_TYPE_INDEX typarr0[] = {0xFFF9,2,186,0xFF01,968,203,0xFFFF};
			EIF_TYPE typres0;
			static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
		...
		((EIF_TYPED_VALUE *)tr1+1)->it_r = loc8;
		RTAR(tr1,loc8);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5053, "is_exceptional", loc4))(loc4)).it_b);
		...
		
		{
			...
			typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
			tr2= RTLNRW(typres0.id, 0, (EIF_POINTER) _A969_39, (EIF_POINTER)(0),5097, 0, 0, 1, -1, tr1, 0);
		}
		ur1 = RTCCL(tr2);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5544, dtype))(Current, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		...
		RTNHOOK(12,1);
		tr3 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5791, "formatted_content", tr2))(tr2)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
		ur5 = RTCCL(tr3);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(5602, Dtype(tr1)))(tr1, ur1x, ur2x, ur3x, ur4x, ur5x);
		RTNHOOK(12,2);
		Result = (EIF_REFERENCE) RTCCL(tr1);
	} else {
		RTHOOK(13);
		...
		tr3 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5791, "formatted_content", tr2))(tr2)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
		ur3 = RTCCL(tr3);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(5590, Dtype(tr1)))(tr1, ur1x, ur2x, ur3x);
		RTNHOOK(13,2);
		Result = (EIF_REFERENCE) RTCCL(tr1);
	}
	RTHOOK(14);
	...
	RTNHOOK(18,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(5796, "wipe_out", tr1))(tr1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(19);
...
EIF_TYPED_VALUE F1031_7855 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1030, Current, 4, 1, 14087);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1030, Current, 14087);
	{
...
body:;
	...
	if ((EIF_BOOLEAN)(loc1 == NULL)) {
		...
		tr1 = RTLNSMART(RTWCT(5544, dtype, Dftype(Current)).id);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(5049, Dtype(tr1)))(tr1);
		RTNHOOK(5,1);
		loc1 = (EIF_REFERENCE) RTCCL(tr1);
	}
	RTHOOK(6);
	...
	tr1 = RTLNTY2(RTWCT(5545, dtype, Dftype(Current)), 0x00);
	...
	ur2 = RTCCL(loc3);
	ur3 = NULL;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(5959, Dtype(tr1)))(tr1, ur1x, ur2x, ur3x);
	RTNHOOK(9,1);
	...
	tr1 = RTLNSMART(RTWCT(5544, dtype, Dftype(Current)).id);
	ur1 = RTCCL(loc2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(5050, Dtype(tr1)))(tr1, ur1x);
	RTNHOOK(10,1);
	loc1 = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(11);
	RTTS;
...
EIF_TYPED_VALUE F1031_8496 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1030, Current, 0, 0, 14084);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1030, Current, 14084);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80003C8, 0,0); /* Result */
	tr1 = RTLNSMART(RTWCT(5545, dtype, Dftype(Current)).id);
