/*
 * Generated by ISE 19.05.10.3351 GPL Edition - windows
 */
...
void egc_init_plug (void)
{
	...
	egc_system_name = "ringbuffer";
	egc_system_location = "C:\\Users\\aless\\OneDrive\\Desktop\\Universita_magistrale_anno_1.1\\Sviluppo_software_in_gruppi_di_lavoro_complessi\\Esercizi_Eiffel\\Eiffel User Files\\19.05\\projects\\RingBuffer\\EIFGENs\\ringbuffer\\W_code";
	egc_compiler_tag = 38;
	egc_project_version = 1639650647;
...
{
	if (egc_rcdt[0] == 0) {
		egc_rcdt[0] = 1005; /* APPLICATION */
	}if (egc_rcdt[1] == 0) {
		egc_rcdt[1] = 1006; /* EQA_EVALUATOR */
	}if (egc_rcdt[2] == 0) {
		egc_rcdt[2] = 1030; /* ITP_INTERPRETER */
	}
}
