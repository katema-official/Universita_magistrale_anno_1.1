...
extern void F962_7222(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {SQUARE}.set_presence */
void F962_7222 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
	char *l_feature_name = "set_presence";
	RTEX;
...
#define up1 up1x.it_p
	...
	RTCC(arg1, 961, l_feature_name, 1, RTWCT(5010, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5010, 0xF80003C2, 0); /* presence */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(5010, dtype)) = (EIF_REFERENCE) tr1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
		RTCT("presence_assigned", EX_POST);
...
{
	GTCX
	char *l_feature_name = "get_presence";
	RTEX;
	EIF_TYPED_VALUE up1x = {{0}, SK_POINTER};
#define up1 up1x.it_p
	EIF_REFERENCE tr1 = NULL;
...
{
	GTCX
	char *l_feature_name = "is_occupied";
	RTEX;
	EIF_TYPED_VALUE up1x = {{0}, SK_POINTER};
#define up1 up1x.it_p
	EIF_REFERENCE tr1 = NULL;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 961, Current, 1, 0, 13524);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
