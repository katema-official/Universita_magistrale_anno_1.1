...
extern EIF_TYPED_VALUE F995_7515(EIF_REFERENCE);
extern EIF_TYPED_VALUE F995_7516(EIF_REFERENCE);
extern void F995_7517(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 994, Current, 1, 0, 13786);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5271, dtype))(Current, up1x);
	RTHOOK(3);
...
RTOID (F995_7515)
EIF_TYPED_VALUE F995_7515 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 994, Current, 0, 0, 13787);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(994, Current, 13787);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F995_7516)
EIF_TYPED_VALUE F995_7516 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 994, Current, 0, 0, 13788);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(994, Current, 13788);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF80003E5, 0,0); /* Result */
...
void F995_7517 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 994, Current, 0, 1, 13789);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(994, Current, 13789);
...
{
	GTCX
	RTOTS (7515,F995_7515)
	RTOTS (7516,F995_7516)
}
