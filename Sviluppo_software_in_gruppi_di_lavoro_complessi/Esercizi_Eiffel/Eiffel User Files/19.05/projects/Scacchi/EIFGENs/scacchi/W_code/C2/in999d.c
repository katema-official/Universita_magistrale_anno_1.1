...
static const EIF_TYPE_INDEX egt_15_999 [] = {0xFF01,453,209,0xFFFF};
static const EIF_TYPE_INDEX egt_16_999 [] = {0xFF01,171,0xFFFF};
...
static const struct desc_info desc_999[] = {
	...
	{EIF_GENERIC(egt_13_999), 13795, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_999), 13805, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_999), 13816, 0xFFFFFFFF},
	{EIF_GENERIC(egt_16_999), 13817, 0xFFFFFFFF},
	...
	{EIF_NON_GENERIC(0x01B5 /*218*/), 13818, 8},
	{EIF_GENERIC(egt_17_999), 13819, 0xFFFFFFFF},
...
void Init999(void)
{
	...
	IDSC(desc_999 + 32, 377, 998);
	IDSC(desc_999 + 51, 392, 998);
}
