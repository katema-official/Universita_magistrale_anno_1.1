...
extern void F997_7519(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F997_7520(EIF_REFERENCE);
extern EIF_TYPED_VALUE F997_7521(EIF_REFERENCE);
extern void F997_7522(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {ITP_CONSTANT}.make */
void F997_7519 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 996, Current, 0, 1, 13791);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(996, Current, 13791);
	RTCC(arg1, 996, l_feature_name, 1, RTWCT(5274, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5274, 0xF8000000, 0); /* value */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 996, Current, 1, 0, 13793);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F997_7522 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTCC(arg1, 996, l_feature_name, 1, eif_new_type(966, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5027, "process_constant", arg1))(arg1, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
